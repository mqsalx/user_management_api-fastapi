...
class AuthController:
    ...
    def __init__(self, session_db: Session = Depends(DatabaseConfig.get_db)):
        ...
        self.__auth_repository = AuthRepository(self.__session_db)
        self.__auth_use_case = AuthUseCase(self.__auth_repository)

    def login(self, request: AuthRequestDTO) -> JSONResponse:
        """
